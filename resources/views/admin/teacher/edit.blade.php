                ...
                <div class="grid gap-4 sm:grid-cols-2">
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="name"
                            ...
                            x-model="editData.name" required>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="email" name="email"
                            class="w-full border rounded-lg p-2 dark:bg-gray-700 dark:text-white"
                            x-model="editData.email" required>
                    </div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="address" rows="2" class="w-full border rounded-lg p-2 dark:bg-gray-700 dark:text-white"
                            x-model="editData.address"></textarea>
                    </div>
                </div>

                <div class="flex justify-end mt-4">
                    <button type="submit"
                        class="px-4 py-2 bg-blue-700 text-white rounded-md hover:bg-blue-800">Update</button>
                </div>
            </form>
        </div>
    </div>
