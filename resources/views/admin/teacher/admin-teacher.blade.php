    ...
    <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden"
                ...
                <x-admin.admin-menu-table button-label="Add Teacher" on-click="openAddModal = true" />
                                    ...
                                    <td class="px-4 py-3 text-right">
                                        ...
                                        <div id="{{ $dropdownId }}"
                                            ...
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200">
                                                <li>
                                                    <button
                                                        @click.stop="
                                                            openEditModal = true;
                                                            editUrl = '{{ route('admin.teachers.update', $teacher->id) }}';
                                                            editData = {
                                                                name: '{{ $teacher->name }}',
                                                                email: '{{ $teacher->email }}',
                                            ...
                                            <div class="py-1">
                                                <button
                                                    @click.stop="
                                                        deleteUrl = '{{ route('admin.teachers.destroy', $teacher->id) }}';
