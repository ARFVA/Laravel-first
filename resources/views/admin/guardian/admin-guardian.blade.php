<x-admin.admin-layout>
    ...
    <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden" x-data="{
            openAddModal: false,
            ...
            <x-admin.admin-menu-table button-label="Add Guardian" on-click="openAddModal = true" />
                    ...
                    <tbody>
                        @foreach ($guardians as $guardian)
                            ...
                            <tr class="border-b dark:border-gray-700">
                                <td class="px-4 py-3">
                                    {{ ($guardians->currentPage() - 1) * $guardians->perPage() + $loop->iteration }}
                                </td>
                                        ...
                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200">
                                            ...
                                            <li>
                                                <button
                                                    @click.stop="
                              openEditModal = true;
                              editUrl = '{{ route('admin.guardians.update', $guardian->id) }}';
                              editData = {
                                name: '{{ $guardian->name }}',
                                job: '{{ $guardian->job }}',
                            ...
                            "
                                        ...
                                        <div class="py-1">
                                            <button type="button"
                                                @click.stop="
                                deleteUrl = '{{ route('admin.guardians.destroy', $guardian->id) }}';
