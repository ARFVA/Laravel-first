<form action="{{ route('students.store') }}" method="POST" class="space-y-4">
    ...
    <div class="grid gap-4 sm:grid-cols-1">
        ...
        <div>
            <label for="classroom" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                Classroom
            </label>
        ...
        <div>
            <div>
                <label for="adress" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                    Address
                </label>
        ...
        <div>
            <label for="score" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                Score
            </label>
