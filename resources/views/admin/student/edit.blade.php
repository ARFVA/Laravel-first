    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg w-full max-w-2xl p-6 relative">
        ...
        <form :action="editUrl" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <select name="classroom_id" x-model="editData.classroom_id"
                    class="w-full border rounded-lg p-2 dark:bg-gray-700 dark:text-white">
            ...
            <div>
                ...
                <input type="text" name="adress" x-model="editData.adress"
                    class="w-full border rounded-lg p-2 dark:bg-gray-700 dark:text-white">
            </div>
            ...
            <div>
                ...
                <input type="date" name="birthday" x-model="editData.birthday"
                    class="w-full border rounded-lg p-2 dark:bg-gray-700 dark:text-white">
            </div>
            ...
            <div>
                ...
                <input type="number" name="score" min="0" max="100" x-model="editData.score"
                    class="w-full border rounded-lg p-2 dark:bg-gray-700 dark:text-white">
            </div>
