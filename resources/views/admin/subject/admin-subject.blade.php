    ...
    <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
        <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden"
                ...
                <x-admin.admin-menu-table button-label="Add Subject" on-click="openAddModal = true" />
                    ...
                    <table class="w-full text-sm text-left text-black-500 dark:text-black-400">
                        ...
                        <tbody>
                            @foreach ($subjects as $subject)
                                @php
                                    $dropdownId = 'dropdown-' . $subject->id;
                                ...
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 text-right">
                                        <button id="{{ $buttonId }}" data-dropdown-toggle="{{ $dropdownId }}"
                                            class="inline-flex items-center p-0.5 text-sm text-gray-500 hover:text-gray-800 dark:text-gray-400">
                                            ...
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200">
                                                <li>
                                                    <button
                                                        @click.stop="
                                                            openEditModal = true;
                                                            editUrl = '{{ route('admin.subjects.update', $subject->id) }}';
                                                            editData = {
                                                                name: '{{ $subject->name }}',
