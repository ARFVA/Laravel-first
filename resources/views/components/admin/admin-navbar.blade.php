        ...
        <div class="flex items-center lg:order-2">
            ...
            <button type="button"
                ...
                <img class="w-8 h-8 rounded-full"
                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSmrHSm3gyVCvfErFNPfu7-hb19YM72sY60Rg&s"
                    alt="user photo" />
            </button>
            <!-- Dropdown menu -->
            <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                id="dropdown">
                <div class="py-3 px-4">
                    <span class="block text-sm font-semibold text-gray-900 dark:text-white">Riffat Arfa</span>
                    <span class="block text-sm text-gray-900 truncate dark:text-white">riffat@gmail.com</span>
                </div>
